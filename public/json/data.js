const portfolios = [
  {
    ...
    pekerjaan: [
      {
        id: 1,
        text: "Mengkonversi design figma yang sebelumnya telah dibuat oleh designer UI/UX menjadi reusable component React Js atomic design yang nantinya dapat digunakan kembali pada komponen lainnya.",
      },
      {
        id: 2,
        text: "Membuat Rest API menggunakan Express Js dan berbagai packages atau dependensi pendukung lain untuk membantu pembuatan API seperti Multer untuk middleware upload file gambar dan video, Cloudinary sebagai tempat penyimpanan, Json Web Token (JWT) sebagai metode authentikasi yang digunakan, Validasi backend menggunakan Joi, Cors untuk menghandle blocking saat integrasi di Frontend, dan lain-lain.",
      },
      {
        id: 3,
        text: "Mengintegrasikan Rest API yang telah dibuat sebelumnya agar menjadi sebuah aplikasi yang utuh, dengan menggunakan berbagai package atau dependensi frontend seperti Axios untuk fetch API, React Redux untuk state management, React Player sebagai pemutar video, dan lain-lain.",
      },
    ],
    stacks: [
      {
  ...
  },
  {
    ...
    pekerjaan: [
      ...
      {
        id: 3,
        text: "Mengintegrasikan Rest API yang telah dibuat sebelumnya agar menjadi sebuah aplikasi yang utuh, dengan menggunakan berbagai package atau dependensi frontend seperti Axios untuk fetch API, React Redux untuk state management, dan lain-lain.",
      },
    ],
    stacks: [
      {
  ...
  },
  {
    ...
    pekerjaan: [
      {
        id: 1,
        text: "Membuat user flow, wireframing, moodboard, sampai membuat visual design menggunakan Invision App dan Figma.",
      },
      {
        id: 2,
        text: "Slicing design figma yang sebelumnya telah dibuat menjadi reusable component React Js yang nantinya dapat digunakan kembali pada komponen lainnya.",
      },
      {
        id: 3,
        text: "Membuat dashboard admin menggunakan template engine ejs, dan membuat API yang nantinya akan diintegrasikan di Frontend.",
      },
      {
        id: 4,
        text: "Integrasi API yang telah dibuat sebelumnya menggunakan beberapa package atau dependensi pendukung seperti Axios untuk fetch API, React Redux sebagai state management, dan lain-lain.",
      },
      {
        id: 5,
        text: "Mendeploy API yang telah dibuat pada Heroku. dan deploy Frontend menggunakan Firebase.",
      },
    ],
    stacks: [
      {
  ...
  },
  {
    ...
    pekerjaan: [
      {
        id: 1,
        text: "Mengkonversi design figma yang sebelumnya telah dibuat oleh designer UI/UX menjadi reusable component React Js yang responsive untuk segala jenis device.",
      },
      {
        id: 2,
        text: "Membuat templating layout untuk bagian yang memiliki desain yang sama agar konsisten seperti header dan footer, dan menjadikannya sebuah komponen Layout.",
      },
      {
        id: 3,
        text: "Melakukan integrasi Rest API yang sebelumnya telah dibuat oleh Backend Developer dan membuat proxy untuk setiap API yang dipanggil dengan menggunakan route api yang telah tersedia pada Next Js, sehingga fetch APi menjadi lebih aman.",
      },
      {
        id: 4,
        text: "Membuat component pre rendering sehingga performerce loading halaman menjadi lebih cepat. Server Side Rendering (SSR) membuat proses rendering menjadi lebih cepat, sehingga dapat meningkatkan SEO pada website.",
      },
      {
        id: 5,
        text: "Melakukan testing pada website yang telah dibuat untuk memastikan tidak terdapat bug atau error, dan kemudian akan di test lebih lanjut oleh QA.",
      },
    ],
    stacks: [
      {
  ...
  },
  {
    ...
    pekerjaan: [
      {
        id: 1,
        text: "Mengkonversi design figma menjadi halaman laravel blade interaktif, dengan menggunakan Bootstrap, Javascript DOM, jQuery, dan Ajax.",
      },
      {
        id: 2,
        text: "Membuat berbagai fitur yang ada pada dashboard admin dengan berbagai role dengan konsep Model, View, Controller (MVC).",
      },
      {
        id: 3,
        text: "Melakukan testing pada website yang telah dibuat untuk memastikan tidak terdapat bug atau error.",
      },
    ],
    stacks: [
      {
  ...
  },
  {
    ...
    pekerjaan: [
      {
        id: 1,
        text: "Mengkonversi design figma yang sebelumnya telah dibuat oleh designer UI/UX menjadi halaman laravel blade interaktif, dengan menggunakan Bootstrap, Javascript DOM, jQuery, dan Ajax.",
      },
      {
        id: 2,
        text: "Membuat berbagai fitur yang ada pada dashboard admin dengan berbagai role dengan konsep Model, View, Controller (MVC).",
      ...
      {
        id: 3,
        text: "Berkolaborasi bersama tim backend lain dengan menggunakan Github sebagai Version Control, dan Trello sebagai project management.",
      },
      {
        id: 4,
        text: "Melakukan testing pada website yang telah dibuat untuk memastikan tidak terdapat bug atau error, dan kemudian akan di test lebih lanjut oleh QA.",
  ...
  },
  {
    ...
    pekerjaan: [
      ...
      {
        id: 2,
        text: "Membuat berbagai fitur yang ada pada dashboard admin dengan berbagai role dengankonsep Model, View, Controller (MVC).",
      },
      {
        id: 3,
        text: "Membuat API yang nantinya akan digunakan untuk diintegrasikan dengan aplikasi mobile, kolaborasi bersama tim backend lain dengan menggunakan Github sebagai Version Control, dan Trello sebagai project management.",
      },
      {
        id: 4,
        text: "Melakukan testing pada website yang telah dibuat untuk memastikan tidak terdapat bug atau error, dan kemudian akan di test lebih lanjut oleh QA.",
  ...
  },
  {
    ...
    thumbnail: "/images/portfolio/inisa/inisa.png",
    link: {
      type: "Website",
      url: "https://inisa.id/",
    },
    role: "Fullstack",
    description: "INISA Company profile merupakan website landing page.",
    pekerjaan: [
      {
        id: 1,
        text: "Melakukan konversi design figma yang sebelumnya telah dibuat oleh designer UI/UX menjadi halaman landing page dengan menggunakan Wordpress CMS, dan menggunakan Elementor sebagai website builder.",
      },
      {
        id: 2,
        text: "Mengisi konten-konten yang sebelumnya telah disiapkan oleh content writer.",
      },
    ],
    stacks: [
      {
